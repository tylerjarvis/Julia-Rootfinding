...
f_7_3 = (x,y) -> cos(x*y/(1.e-09^2))+sin(3*x*y/(1.e-09^2))
g_7_3 = (x,y) -> cos(y/1.e-09)-cos(2*x*y/(1.e-09^2))
...
file_names = ["yroots_roots_1.1", "yroots_roots_1.2", "yroots_roots_1.3", "yroots_roots_1.4", "yroots_roots_1.5", "yroots_roots_2.1", "yroots_roots_2.2", "yroots_roots_2.3", "yroots_roots_2.4", "yroots_roots_2.5", "yroots_roots_3.1", "yroots_roots_3.2", "yroots_roots_4.1", "yroots_roots_4.2", "yroots_roots_5.1", "yroots_roots_6.1", "yroots_roots_6.2", "yroots_roots_6.3", "yroots_roots_7.1", "yroots_roots_7.2", "yroots_roots_7.3", "yroots_roots_7.4", "yroots_roots_8.1", "yroots_roots_8.2", "yroots_roots_9.1", "yroots_roots_9.2", "yroots_roots_10.1"]